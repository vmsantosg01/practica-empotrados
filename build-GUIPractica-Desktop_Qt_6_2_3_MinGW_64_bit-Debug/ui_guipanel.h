...
public:
    ...
    void setupUi(QWidget *GUIPanel)
    {
        ...
        thermometer->setGeometry(QRect(610, 310, 40, 160));
        ...
        checkBoxEnergy->setGeometry(QRect(10, 400, 91, 22));
        checkBoxCaida = new QCheckBox(tab);
        checkBoxCaida->setObjectName(QString::fromUtf8("checkBoxCaida"));
        checkBoxCaida->setGeometry(QRect(10, 430, 91, 22));
        checkBoxQuemaMotores = new QCheckBox(tab);
        checkBoxQuemaMotores->setObjectName(QString::fromUtf8("checkBoxQuemaMotores"));
        checkBoxQuemaMotores->setGeometry(QRect(10, 460, 91, 22));
        checkBoxEnergyb4k = new QCheckBox(tab);
        checkBoxEnergyb4k->setObjectName(QString::fromUtf8("checkBoxEnergyb4k"));
        checkBoxEnergyb4k->setGeometry(QRect(20, 370, 81, 20));
        label = new QLabel(tab);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(490, 340, 71, 91));
        label->setPixmap(QPixmap(QString::fromUtf8(":/imagenes/Robot.png")));
        label->setScaledContents(true);
        explosion = new QLabel(tab);
        explosion->setObjectName(QString::fromUtf8("explosion"));
